...
public class CommandLineArgs {
    ...
    @Parameter(names = {"-metrics-enable"}, description = "Enable built-in Prometheus metrics endpoint")
    private boolean metricsEnable = false;

    @Parameter(names = {"-metrics-path"}, description = "Path of Prometheus metrics endpoint")
